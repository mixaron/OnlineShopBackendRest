...
public class PersonController {
    ...
    @PutMapping("/password")
    public ResponseEntity<HttpStatus> changePassword(@RequestBody ChangePasswordDTO passwordDTO, Authentication authentication) {
    ...
    @PutMapping("/email")
    public ResponseEntity<HttpStatus> changeEmail(@RequestBody ChangePasswordDTO passwordDTO, Authentication authentication) {
